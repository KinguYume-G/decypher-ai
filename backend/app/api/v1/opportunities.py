...
async def list_opportunities(
    ...
    return APIResponse(success=True, data=[OpportunityOut.model_validate(o) for o in opportunities])
...
async def get_opportunity(
    ...
    return APIResponse(success=True, data=OpportunityOut.model_validate(opportunity))
